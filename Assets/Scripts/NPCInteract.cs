...
public class NPCInteract : MonoBehaviour, IDataPersistance
{
    ...
    {
        data.slavkoQuestItemPickedUp = slavkoQuestCompleted;
        data.slavkoHasMetPlayer = slavko.hasMetPlayer;
        data.daoJabuku = daoJabuku;
